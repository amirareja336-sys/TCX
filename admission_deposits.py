...
class SetupFrame(ttk.Frame):
    ...
    def connect(self):
        ...
        try:
            ...
            return
        # Single fixed user — skip the cashier picker.
        self.master.open_main(api, app_cfg, ADMISSION_USER)
...
class MainFrame(ttk.Frame):
    ...
    def build(self):
        ...
        ttk.Button(form, text="Back to Setup", command=self.master.show_setup).grid(row=row + 3, column=0, columnspan=2, sticky="ew", pady=(16, 0))
